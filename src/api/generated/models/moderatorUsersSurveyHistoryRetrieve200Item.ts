 ...
 */
import type { ModeratorUsersSurveyHistoryRetrieve200ItemSurvey } from './moderatorUsersSurveyHistoryRetrieve200ItemSurvey';
import type { ModeratorUsersSurveyHistoryRetrieve200ItemAnswersItem } from './moderatorUsersSurveyHistoryRetrieve200ItemAnswersItem';

export type ModeratorUsersSurveyHistoryRetrieve200Item = {
  id?: string;
  survey?: ModeratorUsersSurveyHistoryRetrieve200ItemSurvey;
  attempt_number?: number;
  status?: string;
  score?: number;
  percentage?: number;
  answers?: ModeratorUsersSurveyHistoryRetrieve200ItemAnswersItem[];
};
