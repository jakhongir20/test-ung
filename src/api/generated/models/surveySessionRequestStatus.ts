...
* `cancelled` - Cancelled
 */
export type SurveySessionRequestStatus = typeof SurveySessionRequestStatus[keyof typeof SurveySessionRequestStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SurveySessionRequestStatus = {
  started: 'started',
