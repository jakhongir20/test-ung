...
* `both` - Both
 */
export type UserProfileUpdateRequestWorkDomain = typeof UserProfileUpdateRequestWorkDomain[keyof typeof UserProfileUpdateRequestWorkDomain];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UserProfileUpdateRequestWorkDomain = {
