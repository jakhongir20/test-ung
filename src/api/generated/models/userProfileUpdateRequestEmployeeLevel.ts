...
* `engineer` - Engineer
 */
export type UserProfileUpdateRequestEmployeeLevel = typeof UserProfileUpdateRequestEmployeeLevel[keyof typeof UserProfileUpdateRequestEmployeeLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UserProfileUpdateRequestEmployeeLevel = {
  junior: 'junior',
  engineer: 'engineer',
  '': '',
} as const;
