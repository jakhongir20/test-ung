 ...
 */
import type { SessionsNextQuestionByOrderRetrieve200Question } from './sessionsNextQuestionByOrderRetrieve200Question';
import type { SessionsNextQuestionByOrderRetrieve200Answer } from './sessionsNextQuestionByOrderRetrieve200Answer';

export type SessionsNextQuestionByOrderRetrieve200 = {
  /** Информация о следующем вопросе */
  question?: SessionsNextQuestionByOrderRetrieve200Question;
  /**
   * Ответ пользователя на этот вопрос (если есть)
   * @nullable
   */
  answer?: SessionsNextQuestionByOrderRetrieve200Answer;
};
