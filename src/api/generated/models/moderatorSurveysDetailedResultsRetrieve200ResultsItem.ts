 ...
 */
import type { ModeratorSurveysDetailedResultsRetrieve200ResultsItemUser } from './moderatorSurveysDetailedResultsRetrieve200ResultsItemUser';

export type ModeratorSurveysDetailedResultsRetrieve200ResultsItem = {
  session_id?: string;
  user?: ModeratorSurveysDetailedResultsRetrieve200ResultsItemUser;
  score?: number;
  percentage?: number;
  is_passed?: boolean;
};
