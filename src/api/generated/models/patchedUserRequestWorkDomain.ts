...
* `both` - Both
 */
export type PatchedUserRequestWorkDomain = typeof PatchedUserRequestWorkDomain[keyof typeof PatchedUserRequestWorkDomain];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PatchedUserRequestWorkDomain = {
