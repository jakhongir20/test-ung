...
* `engineer` - Engineer
 */
export type PatchedUserRequestEmployeeLevel = typeof PatchedUserRequestEmployeeLevel[keyof typeof PatchedUserRequestEmployeeLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PatchedUserRequestEmployeeLevel = {
  junior: 'junior',
  engineer: 'engineer',
  '': '',
} as const;
