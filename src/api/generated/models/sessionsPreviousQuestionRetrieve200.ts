 ...
 */
import type { SessionsPreviousQuestionRetrieve200Question } from './sessionsPreviousQuestionRetrieve200Question';
import type { SessionsPreviousQuestionRetrieve200Answer } from './sessionsPreviousQuestionRetrieve200Answer';

export type SessionsPreviousQuestionRetrieve200 = {
  /** Информация о предыдущем вопросе */
  question?: SessionsPreviousQuestionRetrieve200Question;
  /**
   * Ответ пользователя на этот вопрос (если есть)
   * @nullable
   */
  answer?: SessionsPreviousQuestionRetrieve200Answer;
};
