 ...
 */
import type { SessionsSubmitAnswerCreate200Session } from './sessionsSubmitAnswerCreate200Session';
import type { SessionsSubmitAnswerCreate200FinalScore } from './sessionsSubmitAnswerCreate200FinalScore';

export type SessionsSubmitAnswerCreate200 = {
  message?: string;
  session?: SessionsSubmitAnswerCreate200Session;
  /** Только при завершении сессии */
  final_score?: SessionsSubmitAnswerCreate200FinalScore;
};
