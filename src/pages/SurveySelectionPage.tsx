...
import { useProctorVerifyInitial, useStartSurvey } from '../api/surveys';
...
const SurveySelectionPage: FC = () => {
  ...
  const handleStartTest = async () => {
    ...
    try {
      // Get the selected survey's question count
      const selectedSurveyData = surveys.find(s => s.id === selectedSurvey);
      const questionCount = selectedSurveyData?.questions_count;
      // Start the selected survey
      const res = await startSurvey.mutateAsync({id: selectedSurvey, count: questionCount});
