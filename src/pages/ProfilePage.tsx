...
import { PageTransition, StaggeredFadeIn, FadeIn } from "../components/animations";
    ...
    <BackgroundWrapper>
      <PageTransition>
        <div className="space-y-6 md:p-6">
          ...
          <FadeIn delay={200}>
            <section className={`flex md:gap-4 gap-2.5 flex-col p-4 md:p-8 justify-between bg-[#F8FAFC] border border-[#F1F5F9] rounded-[16px]`}>
              ...
              {surveyHistory.length === 0 ? (
                ...
                <StaggeredFadeIn delay={300} staggerDelay={100} direction="top" className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-fr">
