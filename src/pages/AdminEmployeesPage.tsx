      ...
      <div className="md:p-6">
        ...
        {selectedUserId && (
          <div className="fixed inset-0 z-30">
            ...
            <div
              className="absolute w-full md:right-4 md:top-4 top-16 bottom-0 md:bottom-4 md:w-[min(760px,95vw)] overflow-auto rounded-none md:rounded-[16px] bg-white ring-1 ring-gray-200 shadow-xl p-6">
